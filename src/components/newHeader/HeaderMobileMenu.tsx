...
const MenuItem = styled.div<{ showBorder?: boolean; isSelected?: boolean }>`
  ...
  padding: 12px 0;
  border-top: ${({ showBorder, theme }) =>
    showBorder ? `1px solid #333232` : 'unset'};
  cursor: pointer;
`;
...
export const HeaderMobileMenu = (props: Props) => {
  ...
  return (
    <Wrapper>
      <MobileAndTableMini>
        <TopButtonGroup>
          <div className="menu-start-building" onClick={props.startBuild}>
            {t('startBuilding')}
          </div>
          <div
            className="menu-view-documentation"
      ...
      <MenuItem
        isSelected={props.currentTab.name === t('home')}
        onClick={() => props.handleChange(props.navList[0])}
        showBorder={true}
      >
        Home
      </MenuItem>
      ...
      <Accordion>
        ...
        >
          <ClvChainGroup>
            <MenuItem
              isSelected={props.currentTab.name === t('CLVChains')}
              onClick={() => {
            ...
            <img
              src={
                showMore ? 'images/arrow_to_up.svg' : 'images/arrow_to_down.svg'
              }
              alt=""
        ...
        <AccordionDetails>
          <ClvChains>
            <ClvChainItem
              onClick={() =>
                window.open(props.navList[1].menuList[0].url, '_blank')
              }
            >
            ...
            <ClvChainItem
              onClick={() =>
                window.open(props.navList[1].menuList[1].url, '_blank')
              }
            >
              EVM Bridge
            </ClvChainItem>
            <ClvChainItem
              onClick={() =>
                window.open(props.navList[1].menuList[2].url, '_blank')
              }
            >
              CLV Scan
            </ClvChainItem>
      ...
      <MenuItem
        isSelected={props.currentTab.name === t('about')}
        onClick={() => props.handleChange(props.navList[2])}
        showBorder={true}
      >
        About
      </MenuItem>
      ...
      <MenuItem
        isSelected={props.currentTab.name === t('developers')}
        onClick={() => props.handleChange(props.navList[3])}
        showBorder={true}
      >
        Developers
      </MenuItem>
      <MenuItem
        isSelected={props.currentTab.name === t('ecosystem')}
        onClick={() => props.handleChange(props.navList[4])}
        showBorder={true}
      >
        Ecosystem
      </MenuItem>
